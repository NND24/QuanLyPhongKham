...
public class DichVuKhamBenhModelTest extends NhomDichVuKhamBenhModelTest {

    private String maDichVuKB, tenDichVuKB;
    private int giaTien, giaBaoHiem;
    private String trangThai;

    public DichVuKhamBenhModelTest(String maDichVuKB, String tenDichVuKB, int giaTien, int giaBaoHiem, String trangThai, String maNhomDichVuKB) {
    ...
    public DichVuKhamBenhModelTest(String maDichVuKB, String tenDichVuKB, int giaTien, int giaBaoHiem, String trangThai, String maNhomDichVuKB, String tenNhomDichVuKB) {
