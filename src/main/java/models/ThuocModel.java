...
public class ThuocModel {
    ...
    private int giaTien, giaBHYT;
    private String trangThai;

    public ThuocModel(String maThuoc, String tenThuoc, String tenHoatChat, String maNhomThuoc, String duongDung, String hamLuong, String soDangKy, String dongGoi, String donViTinh, String hangSanXuat, String nuocSanXuat, int giaTien, int giaBHYT, String trangThai) {
    ...
    public ThuocModel(String maThuoc, String tenThuoc, String tenHoatChat, String maNhomThuoc, String tenNhomThuoc, String duongDung, String hamLuong, String soDangKy, String dongGoi, String donViTinh, String hangSanXuat, String nuocSanXuat, int giaTien, int giaBHYT, String trangThai) {
        this.maThuoc = maThuoc;
        this.tenThuoc = tenThuoc;
        this.tenHoatChat = tenHoatChat;
        this.maNhomThuoc = maNhomThuoc;
    ...
    public ThuocModel(String maThuoc, String tenThuoc, String duongDung, int giaTien, int giaBHYT, String trangThai) {
        this.maThuoc = maThuoc;
        this.tenThuoc = tenThuoc;
        this.giaTien = giaTien;
        this.giaBHYT = giaBHYT;
