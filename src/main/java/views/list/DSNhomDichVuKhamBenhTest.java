...
public class DSNhomDichVuKhamBenhTest extends javax.swing.JFrame {
    ...
    public DSNhomDichVuKhamBenhTest() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(DSNhomDichVuKhamBenhTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (txtTenNhomDichVu.getText().isEmpty()) {
            ...
            try {
                ...
                NhomDichVuKhamBenhModelTest ndv = new NhomDichVuKhamBenhModelTest(maNhomDichVu, tenNhomDichVu, trangThai);
                NhomDichVuKhamBenhCtrlTest.themNhomDichVuKhamBenh(ndv);
                lamMoi();
                hienThiTatCaNhomDichVu();
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(DSNhomDichVuKhamBenhTest.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
            ...
            if (maNhomDichVu.isEmpty()) {
                ...
                if (DialogHelper.showConfirmation("Bạn có chắc muốn xóa nhóm dịch vụ khám bệnh này")) {
                    NhomDichVuKhamBenhCtrlTest.xoaNhomDichVuKhamBenh(maNhomDichVu);
        ...
        try {
            if (txtMaNhomDichVu.getText().isEmpty()) {
                ...
                if (DialogHelper.showConfirmation("Bạn có chắc muốn sửa nhóm dịch vụ khám bệnh này")) {
                    ...
                    NhomDichVuKhamBenhModelTest ndv = new NhomDichVuKhamBenhModelTest(maNhomDichVu, tenNhomDichVu, trangThai);
                    NhomDichVuKhamBenhCtrlTest.capNhatNhomDichVuKhamBenh(ndv);
    ...
    private void tblDSNhomDichVuKBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDSNhomDichVuKBMouseClicked
        ...
        if (selectedIndex >= 0) {
            NhomDichVuKhamBenhModelTest ndv = dsNhomDichVu.get(selectedIndex);
    ...
    private void btnXuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatActionPerformed
        try {
            dsNhomDichVu = NhomDichVuKhamBenhCtrlTest.timTatNhomDichVuKhamBenh();
            NhomDichVuKhamBenhCtrlTest.exportToExcel(dsNhomDichVu, "src/main/java/ExcelStorage/DSNhomDichVuKhamBenh.xlsx");
    ...
    private void txtTimKiemKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemKeyTyped
        try {
            ...
            if (timKiem.equals("")) {
                ...
                dsNhomDichVu = NhomDichVuKhamBenhCtrlTest.timTatCaDichVuTheoDK(timKiem);
                tableModel.setRowCount(0);
