...
public class DSDichVuCLSTest extends javax.swing.JFrame {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        if (txtTenDichVu.getText().isEmpty()) {
            ...
            try {
                ...
                DichVuCLSModelTest dv = new DichVuCLSModelTest(maDichVu, tenDichVu, maNhomDichVu, giaTien, giaBaoHiem, trangThai);
        ...
        try {
            if (cmbTimKiemNhomDichVu.getSelectedItem() != null) {
                ...
                if (timKiem.equals("")) {
                    ...
                    int nhomDichVuId = cmbNhomDichVu.getSelectedIndex();
                    String maNhomDichVu = dsNhomDichVu.get(nhomDichVuId).getMaNhomDichVuCLS();
                    dsDichVu = DichVuCLSCtrlTest.timTatCaDichVuTheoDK(timKiem, maNhomDichVu);
                    tableModel.setRowCount(0);
    ...
    private void btnxuatDSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxuatDSActionPerformed
        try {
            dsDichVu = DichVuCLSCtrlTest.timTatCaDichVu();
            DichVuCLSCtrlTest.exportToExcel(dsDichVu, "src/main/java/ExcelStorage/DSDichVuCLS.xlsx");
